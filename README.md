...
![Plugin Version](https://img.shields.io/badge/Plugin-1.3.3-informational.svg)
...
- 🔄 **多平台支持**：支持 OpenAI 标准 Images API、OpenAI Chat Completion 兼容、NovelAI 兼容接口、Google Gemini 图片生成 API，及智谱图片生成API。
